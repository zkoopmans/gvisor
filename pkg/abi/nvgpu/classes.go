...
const (
	...
	BLACKWELL_USERMODE_A             = 0x0000c761 // 570.86.15
	AMPERE_A                         = 0x0000c697
	...
	BLACKWELL_CHANNEL_GPFIFO_A       = 0x0000c96f // 560.28.03
	BLACKWELL_CHANNEL_GPFIFO_B       = 0x0000ca6f // 570.86.15
	HOPPER_DMA_COPY_A                = 0x0000c8b5
	BLACKWELL_DMA_COPY_A             = 0x0000C9B5 // 560.28.03
	BLACKWELL_DMA_COPY_B             = 0x0000CAB5 // 570.86.15
	ADA_A                            = 0x0000c997
	...
	BLACKWELL_A                      = 0x0000cd97 // 560.28.03
	BLACKWELL_COMPUTE_A              = 0x0000cdc0 // --
	BLACKWELL_B                      = 0x0000ce97 // 570.86.15
	BLACKWELL_COMPUTE_B              = 0x0000cec0 // --
	BLACKWELL_INLINE_TO_MEMORY_A     = 0x0000cd40 // 560.28.03
)
