	...
	abisOnce.Do(func() {
		...
		v545_23_06 := func() *driverABI {
			...
			abi.getStructs = func() *driverABIStructs {
				...
				structs.controlStructs[nvgpu.NV00DE_CTRL_CMD_REQUEST_DATA_POLL] = driverStructs(nvgpu.NV00DE_CTRL_CMD_REQUEST_DATA_POLL_PARAMS{})
		...
		v560_28_03 := func() *driverABI {
			...
			abi.getStructs = func() *driverABIStructs {
				...
				structs.allocationStructs[nvgpu.KEPLER_INLINE_TO_MEMORY_B] = driverStructs(nvgpu.NV_GR_ALLOCATION_PARAMETERS{})
				return structs
			}
			return abi
		}
		...
		v570_86_15 := addDriverABI(570, 86, 15, "87709c19c7401243136bc0ec9e7f147c6803070a11449ae8f0819dee7963f76b", func() *driverABI {
			...
			abi.getStructs = func() *driverABIStructs {
				...
				structs.allocationStructs[nvgpu.HOPPER_USERMODE_A] = driverStructs(nvgpu.NV_HOPPER_USERMODE_A_PARAMS{})
				return structs
			}
			return abi
		})
