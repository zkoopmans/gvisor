...
func newRootNetworkNamespace(conf *Config, clock tcpip.Clock, uniqueID stack.UniqueID) (*inet.NetworkNamespace, error) {
	...
	case NetworkHost:
		...
		return inet.NewRootNetworkNamespace(hostinet.NewStack(), nil), nil
	...
	case NetworkNone, NetworkSandbox:
		...
		return inet.NewRootNetworkNamespace(s, creator), nil
